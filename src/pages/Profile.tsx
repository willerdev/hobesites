...
const Profile = () => {
  ...
  return (
    <div className="bg-white text-sky-600 min-h-screen relative pb-20">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-2">
          <div className="w-32 h-32 bg-sky-100 rounded-full flex-shrink-0 mr-6">
        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-4">
            <Link to="/wallet" className="bg-sky-100 text-sky-600 px-4 py-2 rounded-full">
              Check Wallet
            </Link>
            <Link to="/transactions" className="bg-sky-100 text-sky-600 px-4 py-2 rounded-full">
              Check Transactions
            </Link>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          {recentlyViewedItems.length === 0 ? (
            ...
            <div className="flex space-x-4">
              <Link to="/recentlyViewed" className="bg-sky-100 text-sky-600 px-4 py-2 rounded-full whitespace-nowrap">
                All
              </Link>
              {recentlyViewedItems.slice(0, 2).map((item, index) => (
                <Link key={index} to={item.link} className="bg-sky-100 text-sky-600 px-4 py-2 rounded-full whitespace-nowrap">
                  {item.title}
                </Link>
              ))}
              {recentlyViewedItems.length > 2 && (
                <Link to="/recently-viewed" className="bg-sky-100 text-sky-600 px-4 py-2 rounded-full whitespace-nowrap">
                  View more
                </Link>
              )}
            </div>
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link to="/favorites" className="flex items-center p-3 bg-sky-100 rounded-lg">
              <Heart className="mr-2" />
              <span>Favorites</span>
            </Link>
            <Link to="/myads" className="flex items-center p-3 bg-sky-100 rounded-lg">
              <List className="mr-2" />
              <span>My Listings</span>
            </Link>
            <Link to="/purchases" className="flex hidden items-center p-3 bg-sky-100 rounded-lg">
              <ShoppingBag className="mr-2" />
              <span>Purchases</span>
            </Link>
            <Link to="/savings" className="flex hidden items-center p-3 bg-sky-100 rounded-lg">
              <PiggyBank className="mr-2" />
              <span>Savings</span>
            </Link>
            <Link to="/events" className="flex items-center p-3 bg-sky-100 rounded-lg">
              <Gift className="mr-2" />
              <span>Events</span>
            </Link>
            <Link to="/whats-new" className="flex items-center p-3 bg-sky-100 rounded-lg">
          ...
          <ul className="space-y-2">
            <li className="flex items-center justify-between">
              ...
              <div className="flex space-x-2">
                <button onClick={() => handleEditClick('name')} className="p-2 rounded-full bg-sky-100 text-sky-500">
                  <Edit size={20} />
                </button>
                <button onClick={() => handleEditClick('password')} className="p-2 rounded-full bg-sky-100 text-sky-500">
                  <Key size={20} />
                </button>
                <button onClick={() => handleEditClick('phone')} className="p-2 rounded-full bg-sky-100 text-sky-500">
                  <Phone size={20} />
                </button>
                <button onClick={() => handleEditClick('address')} className="p-2 rounded-full bg-sky-100 text-sky-500">
                  <MapPin size={20} />
                </button>
              </div>
            </li>
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-2">My Hobe Shop</h2>
          <Link to="/shop-settings" className="bg-sky-500 text-white px-4 py-2 rounded-lg hover:bg-sky-600 transition-colors duration-300">
            Shop Settings
          </Link>
          <Link to="/myads" className="bg-sky-100 text-sky-600 px-4 py-2 rounded-lg inline-flex items-center">
        ...
        <div className="mb-6">
          ...
          <Link to="/support" className="flex items-center p-3 bg-sky-100 rounded-lg">
        ...
        {/* <div className="mb-6">
          ...
          <Link to="/earn-with-karrot" className="flex items-center p-3 bg-sky-100 rounded-lg">
